...
public class SelfDiscipline implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "The control of mind over body, the ability to " +
				"push harder in pursuit of some goal, or to draw upon " +
				"the inner reserves of strength inheent in any " +
				"individual. Also referred to as: will, alignment, " +
				"faith, mental strength or power, concentration, " +
				"self control, determination, zeal, etc.";
		return desc;
	}
