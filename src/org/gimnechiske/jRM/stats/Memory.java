...
public class Memory implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "The ability  to retain what has previously been " +
				"encounntered and learned. Note that in many instances " +
				"it may be necessary for the character to rely on the " +
				"player's memory, since that tends to be used whenever " +
				"it is advantageous anyway. Memory provides a good basis " +
				"for determining how much is retained of the pre-adult " +
				"period that the Gamemaster doesn't have time to devise " +
				"and descrive in absolute detail to each player. Also " +
				"referred to as: intelligence, wisdom, information " +
				"capacity, mental capacity, recall, retention, recognition, " +
				"etc.";
		return desc;
	}
