...
public class Quickness implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "Essentially a measure of reflexes and conscious " +
				"reaction time, this stat is often lumped with several " +
				"other as dexterity. Also referred to as: agility, " +
				"dexterity, speed, reaction ability, readiness, dodging " +
				"ability, litheness, etc.";
		return desc;
	}
