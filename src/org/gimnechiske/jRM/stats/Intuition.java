...
public class Intuition implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "A combination of luck, genius, precognition " +
				"ESP, and the favor of the gods is embodied in this " +
				"stat. Also referred to as: wisdom, luck, talent, " + 
				"reactive ability (mental), guessing ability, " +
				"psychic ability, insight, clairvoyance, inspiration " +
				" perception, presentiment, etc.";
		return desc;
	}
