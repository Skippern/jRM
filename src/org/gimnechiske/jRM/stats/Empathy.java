...
public class Empathy implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "The relationship of the character to the " +
				"all-prevading force that is common to all things " +
				"natural and is the basis of most things supernatural. " +
				"Also referred to as: emotional capacity, judgement, " +
				"alignment, wisdom, mana, magical prowess, bardic" + 
				"voice, etc.";
		return desc;
	}
