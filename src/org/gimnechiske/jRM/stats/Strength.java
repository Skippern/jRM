...
public class Strength implements Stat {
	...
	public String getDescription() {
		String desc = "Not brute musculature, but the ability to use " +
				"existing muscles to their greatest advantage. Also " +
				"referred to as: power, might, force, stamina, " +
				"endurance, conditioning, physique, etc.";
		return desc;
	}
