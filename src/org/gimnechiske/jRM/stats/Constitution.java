...
public class Constitution implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "General health and well-being, reistance to " +
				"disease, and the ability to absorbe more damage are all " +
				"reflected in a character's Constitution. Also referred to " +
				"as: health, stamina, endurance, physical resistance, " +
