...
public class Agility implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "Manual dexterity and lightness are the prime " +
				"components of this characteristic. Also referred to as: " +
				"dexterity, deftness, manual skill, adroitness, " + 
				"maneuverability, stealth, dodging ability, litheness, etc.";
		return desc;
	}
