...
public class Presence implements Stat {
	private int temp;
	private int pot;
	private int special;
	...
	public String getDescription() {
		String desc = "Control of one's own mind, courage, bearing, " +
				"self esteem, charisma, outwards appearance and the " +
				"ability to use these to affect and control others " +
				"are the principal elements of a character's presence." +
				"Also referred to asL appearance, level-headedness, " +
				"panic resistance, morale, psychic ability, self control, " +
				"vanity, perceived power, mental discipline, bardic " +
				"voice, charisma, etc";
		return desc;
	}
