...
public class ScienceAnalyticSpecialized implements SkillCategory {
	...
	public ScienceAnalyticSpecialized() {
	...
	public String getName() {
		return "Science/Analytic * Specialized";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.RE, LibStats.ME, LibStats.RE};
		return tmp;
	}
