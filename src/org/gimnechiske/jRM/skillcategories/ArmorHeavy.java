...
public class ArmorHeavy implements SkillCategory {
	...
	public ArmorHeavy() {
		Skill s = new CombatArmor(this);
		skillList.add(s);
		s = new PoweredArmor(this);
		skillList.add(s);
		s = new PlateArmor(this);
		skillList.add(s);
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.ST, LibStats.AG, LibStats.ST};
		return tmp;
	}
}
