...
public class TechnicalTradeVehicles implements SkillCategory {
	...
	public String getName() {
		return "Technical/Trade * Vehicles";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.AG, LibStats.IN, LibStats.AG };
		return tmp;
	}
