...
public class AwarenessPerception implements SkillCategory {
	...
	public AwarenessPerception() {
		Skill s = new Alertness(this);
		skillList.add(s);
		s = new SenseAmbush(this);
		skillList.add(s);
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.IN, LibStats.SD, LibStats.IN};
		return tmp;
	}
}
