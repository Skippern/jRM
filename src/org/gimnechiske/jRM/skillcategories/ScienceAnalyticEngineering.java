...
public class ScienceAnalyticEngineering implements SkillCategory {
	...
	public ScienceAnalyticEngineering() {
	...
	public String getName() {
		return "Science/Analytic * Engineering";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.ME, LibStats.RE, LibStats.IN };
		return tmp;
	}
