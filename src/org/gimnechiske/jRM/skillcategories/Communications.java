...
public class Communications implements SkillCategory {
	...
	public Communications() {
		Skill s = new LipReading(this);
		skillList.add(s);
		s = new Signaling(this);
		skillList.add(s);
		s = new SpeedReading(this);
		skillList.add(s);
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.RE, LibStats.ME, LibStats.EM};
		return tmp;
	}
