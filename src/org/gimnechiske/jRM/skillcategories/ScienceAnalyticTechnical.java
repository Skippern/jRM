...
public class ScienceAnalyticTechnical implements SkillCategory {
	...
	public ScienceAnalyticTechnical() {
	...
	public String getName() {
		return "Science/Analytic * Technical";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.RE, LibStats.ME, LibStats.AG };
		return tmp;
	}
