...
public class PsychicElectrokinesis implements SkillCategory {
	...
	public int[] getStats() {
		int[] tmp = { LibStats.SD, LibStats.SD, LibStats.IN};
		return tmp;
	}
