...
public class TechnicalTradeVocational implements SkillCategory {
	...
	public TechnicalTradeVocational() {
	...
	public String getName() {
		return "Technical/Trade * Vocational";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.ME, LibStats.IN, LibStats.RE };
		return tmp;
	}
