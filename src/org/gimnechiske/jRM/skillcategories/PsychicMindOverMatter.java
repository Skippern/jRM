...
public class PsychicMindOverMatter implements SkillCategory {
	...
	public String getName() {
		return "Psychic * Mind Over Matter";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.SD, LibStats.SD, LibStats.SD};
		return tmp;
	}
