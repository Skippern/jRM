...
public class MartialArtsCombatManeuvers implements SkillCategory {
	...
	public MartialArtsCombatManeuvers() {
	...
	public String getName() {
		return "Martial Arts * Combat Maneuvers";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.AG, LibStats.QU, LibStats.SD};
		return tmp;
	}
