...
public class TechnicalTradeGunnery implements SkillCategory {
	...
	public String getName() {
		return "Technical/Trade * Gunnery";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.IN, LibStats.AG, LibStats.AG };
		return tmp;
	}
