...
public class WeaponMissileArtillery implements SkillCategory {
	...
	public String getName() {
		return "Weapon * Missile Artillery";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.IN, LibStats.AG, LibStats.RE };
		return tmp;
	}
