...
public class TechnicalTradeGeneral implements SkillCategory {
	...
	public String getName() {
		return "Technical/Trade * General";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.RE, LibStats.ME, LibStats.SD };
		return tmp;
	}
