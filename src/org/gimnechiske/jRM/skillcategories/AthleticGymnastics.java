...
public class AthleticGymnastics implements SkillCategory {
	...
	public int[] getStats() {
		int[] tmp = { LibStats.AG, LibStats.QU, LibStats.AG};
		return tmp;
	}
}
