...
public class MindPointDevelopment implements SkillCategory {
	...
	public MindPointDevelopment() {
		Skill s = new MindPointDevelopmentSkill(this);
		skillList.add(s);
	}
	...
	public double[] getSkillProgression() {
		if (myRace != null) return myRace.getPsychicDev();
		return Progression.NONE;
	}
