...
public class OutdoorEnvironmental implements SkillCategory {
	...
	public int[] getStats() {
		int[] tmp = { LibStats.SD, LibStats.IN, LibStats.ME};
		return tmp;
	}
