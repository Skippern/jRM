...
public class TechnicalTradeProfessional implements SkillCategory {
	...
	public TechnicalTradeProfessional() {
		Skill s = new Architecture(this);
		skillList.add(s);
		s = new WorkForceOrganization(this);
		skillList.add(s);
	}
	...
	public String getName() {
		return "Technical/Trade * Professional";
	}
	...
	public int[] getStats() {
		int[] tmp = { LibStats.RE, LibStats.ME, LibStats.IN };
		return tmp;
	}
