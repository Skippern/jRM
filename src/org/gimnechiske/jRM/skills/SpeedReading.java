...
public class SpeedReading implements Skill {
	...
	public SpeedReading(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill is used to quickly assimilate written text. " +
				"A successful maneuver results in reading at 2 to 3 times " +
				"normal rate with full retention. Failure indicates a " +
				"distraction.";
	}
