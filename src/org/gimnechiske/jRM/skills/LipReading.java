...
public class LipReading implements Skill {
	...
	public LipReading(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for reading lips and sign " +
				"language. Lip reading is only possible with languages " +
				"that the lip reader knows and then only to the known " +
				"spoken skill rank. Special creatures (e.g., the Chicken " +
				"People) might cause a penalty to be added to the " +
				"character's bonus due to distinct lack of lips. Line of " +
				"sight must be maintained with the subject's mouth. " +
				"Skill is halved for reading the lips of creatures not " +
				"of the same general type.\nTypes: Human, Reptile, Avian, " +
				"Non-Human Mammalian, etc.";
	}
