...
public class PoisonPerception implements Skill {
	...
	public PoisonPerception(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Poison Perception";
	}
	public String getDescription() {
		return "This skill provides a bonus for perceiving the presence " +
				"of poison in/on an item or object. Note that some poisons " +
				"will simply be undetectable (e.g., a colorless, tasteless, " +
				"odorless powder that dissolves completely in water will be " +
