...
public class DetectTraps implements Skill {
	...
	public DetectTraps(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for detecting inanimate traps " +
				"or ambuses. Note that this skill is not \"automatic\"; " +
				"the individual must state that he is searching for signs " +
				"of a trap or ambush for this skill to come into play.";
	}
