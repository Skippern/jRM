...
public class LocateHidden implements Skill {
	...
	public LocateHidden(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Locate Hidden";
	}
	public String getDescription() {
		return "This skill provides a bonus for locating secret openings " +
				"or hidden objects.";
	}
