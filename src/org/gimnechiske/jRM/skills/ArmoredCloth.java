...
public class ArmoredCloth implements Skill {
	...
	public ArmoredCloth(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Armored Cloth";
	}
	public String getDescription() {
		return "Kevlar coverings to protect against ballistic attacks. " +
				"This armor becomes absolete with the invention of " +
				"kinetic armor, but sometimes worked into clothing, as " +
				"the technology form making this light and flexible is " +
				"always one step ahead of kinetic armor.";
	}
