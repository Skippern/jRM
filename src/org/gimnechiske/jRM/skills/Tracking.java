...
public class Tracking implements Skill {
	...
	public Tracking(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for tracking maneuvers and " +
				"following of a trail left by someone or something such " +
				"as foot prints, broken branches, crushed grass, hanging " +
				"pieces of cloth, etc. The skill 'Reading Tracks' gives " +
				"the tracker the information about the tracks.";
	}
