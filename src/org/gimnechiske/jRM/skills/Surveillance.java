...
public class Surveillance implements Skill {
	...
	public Surveillance(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for keeping watch over a " +
				"person, place or object. Also includes the ability " +
				"to determine the best approach and technique in " +
				"solving a crime.";
	}
