...
public class WorkForceOrganization implements Skill {
	...
	public WorkForceOrganization(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Work Force Organization";
	}
	public String getDescription() {
		return "This skill allows the architect to orchestrate the work " +
				"on any construction project. This would include " +
				"knowledge of the proper way to hire, oversee, and " +
				"effectively employ a given work force.";
	}
