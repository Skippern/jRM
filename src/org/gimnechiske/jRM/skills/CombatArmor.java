...
public class CombatArmor implements Skill {
	...
	public CombatArmor(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This type of armor mimics older, more archaic plate " +
				"armor. It is made from a hardened composite shell. It " +
				"relatively lightweight, and is efficient both at energy " +
				"dispersal and projectile deflection. It is designed " +
				"soecifically to foil energy weapons. These armors are " +
				"the only type designed specifically to be used with " +
				"armor add-ons.";
	}
