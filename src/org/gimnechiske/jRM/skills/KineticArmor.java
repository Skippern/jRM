...
public class KineticArmor implements Skill {
	...
	public KineticArmor(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Kinetic Armor";
	}
	public String getDescription() {
		return "This flexible armor becomes rigid when dealt a blow. " +
				"This greatly reduces the effects of projectiles. It " +
				"absorbs some of the energy from energy weapon, but " +
				"is most useful against firearms.";
	}
