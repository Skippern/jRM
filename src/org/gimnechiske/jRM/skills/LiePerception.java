...
public class LiePerception implements Skill {
	...
	public LiePerception(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Lie Perception";
	}
	public String getDescription() {
		return "This skill provides a bonus for perceiving lies told by " +
				"an individual under proximate observation (within 10' " +
				"and within visual/hearing range) by the user of this " +
				"skill.";
	}
