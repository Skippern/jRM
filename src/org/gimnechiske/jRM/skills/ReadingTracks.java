...
public class ReadingTracks implements Skill {
	...
	public ReadingTracks(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for gleaning information " +
				"from a set of tracks or spoor. The detailed information " +
				"about the tracks can be obtained, such as type of " +
				"creature, age of tracks, weight of creature, speed " +
				"creature moving at, back tracking, etc. This skill is " +
				"used for identifying the tracks and the skill 'Tracking' " +
				"(q.v.) is used for spotting and following the tracks.";
	}
