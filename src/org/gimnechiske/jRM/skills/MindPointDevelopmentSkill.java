...
public class MindPointDevelopmentSkill implements Skill {
	...
	public MindPointDevelopmentSkill(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Mind Point Development";
	}
	public String getDescription() {
		return "Developming this skill allows a psychic character to " +
				"increase the total number of mind points (MPs) he may " +
				"have available at any given time. In order to use a " +
				"psychic power, a number of MPs equal to the psychic " +
				"power's magnitude must be used.";
	}
