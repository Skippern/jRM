...
public class Signaling implements Skill {
	...
	public Signaling(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus when using any form of " +
				"signal communications. This skill is a specialized " +
				"form of linguistics and linguistics guidelines apply.";
	}
