...
public class RigidLeatherArmor implements Skill {
	...
	public RigidLeatherArmor(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getName() {
		return "Rigid Leather";
	}
	public String getDescription() {
		return "Rigid leather armor and the rigid hide covering of certain " +
				"reptiles and of other creatures such as Dragons.";
	}
