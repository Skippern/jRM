...
public class Architecture implements Skill {
	...
	public Architecture(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill provides a bonus for designing buildings, " +
				"reading or creating blueprints and technical diagrams, " +
				"and evaluating or appraising structures. This skill may " +
				"also provide a bonus for locating hidden spaces within a " +
				"structure.";
	}
