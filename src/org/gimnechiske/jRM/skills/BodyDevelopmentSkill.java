...
public class BodyDevelopmentSkill implements Skill {
	...
	public BodyDevelopmentSkill(SkillCategory sc) {
		myCat = sc;
	}
	...
	public String getDescription() {
		return "This skill enhances the character's ability to resist " +
				"damage, and withstand pain and shock. A character's " +
				"Body Development skill bonus determines how many hits " +
				"(concussion hits) a character can take without passing " +
				"out. Note that this is not merely strength training - " +
				"training in this skill provides a greater tolerance " +
				"for pain, physical toughness and discipline in the " +
				"face of wounds and bleeding. An individual might remain " +
				"a very slight and frail-looking individual but still " +
				"hold a large number of ranks of body development.";
	}
